...
teks =
`${botname} | Runtime : ${runtime(process.uptime())}\nOwner : ${ownername}`
Ryuu.sendMessage(from, { contentText: `${menu}`, footerText: `${teks}`, buttons: [{ buttonId: `${prefix}donasi`, buttonText: { displayText: 'DONASI 💵' }, type: 1 },{ buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER 🌱' }, type: 1 },{ buttonId: `${prefix}sc`, buttonText: { displayText: 'SCRIPT' }, type: 1 },{ buttonId: `${prefix}github`, buttonText: { displayText: 'GITHUB' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: fakeimage, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
break
case 'groupmenu':
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
if (isBanned) return reply('Kamu Sudah Di banned!')
...
reply(`Itu Kak Nomor Owner Ku Kak Save Ya Kak`)
break
case 'creator':
...
break
case 'sc': case 'sc':
reply(`Kalo Mau Sc Ke Chat Owner wa.me/6285781571707`)
break
case 'github':
reply(`Nih Github Owner https://github.com/Hnrmantap
case 'rules':
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
if (isBanned) return reply('Kamu Sudah Di banned!')
menu =
...
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound2':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
...
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj1.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound7':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj2.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound8':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj3.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound9':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj4.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound10':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj5.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound11':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj6.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound12':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj7.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound13':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj8.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound14':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj9.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound15':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj10.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound16':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj11.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound17':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj12.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound18':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj13.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound19':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj14.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound20':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj15.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound21':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj16.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound22':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj17.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound23':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj18.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound24':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj19.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound25':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj20.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound26':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj21.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound27':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj22.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound28':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj23.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound29':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj24.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound30':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj25.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound31':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj26.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound32':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj27.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound33':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj28.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound34':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj29.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound35':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj30.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound36':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj31.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound37':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj32.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound38':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj33.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound39':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj34.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound40':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj35.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound41':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj36.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound42':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj37.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound43':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj38.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound44':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj39.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound45':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/dj40.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound46':
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
reply(mess.wait) 
man = fs.readFileSync('./assets/sound41.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound47':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
man = fs.readFileSync('./assets/sound42.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound48':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
man = fs.readFileSync('./assets/sound43.mp3');
reply(mess.wait) 
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound49':
...
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/sound44.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound50':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/sound45.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound51':
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
reply(mess.wait) 
man = fs.readFileSync('./assets/sound46.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound52':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
man = fs.readFileSync('./assets/sound47.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound53':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
man = fs.readFileSync('./assets/sound48.mp3');
reply(mess.wait) 
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound54':
...
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/sound49.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound55':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/sound50.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound56':
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
reply(mess.wait) 
man = fs.readFileSync('./assets/sound51.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound57':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
man = fs.readFileSync('./assets/sound52.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound58':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
man = fs.readFileSync('./assets/sound53.mp3');
reply(mess.wait) 
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound59':
...
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/sound54.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound60':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/sound55.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound61':
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
reply(mess.wait) 
man = fs.readFileSync('./assets/sound56.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound62':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
man = fs.readFileSync('./assets/sound57.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound63':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
man = fs.readFileSync('./assets/sound58.mp3');
reply(mess.wait) 
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound64':
...
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/sound59.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
case 'sound65':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
reply(mess.wait) 
man = fs.readFileSync('./assets/sound60.mp3');
Ryuu.sendMessage(from, man, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
//Fitur Convert
